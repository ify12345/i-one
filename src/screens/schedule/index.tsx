    ...
    <HomeLayout>
      <div className="flex flex-col lg:flex-row gap-[54px] lg:px-[80px] w-full">
        ...
        <div className="lg:w-7/12 w-full">
          ...
          <div className="bg-white p-6 rounded-[20px] shadow-md border-[#00E0821A]">
            {activeTab === 'all' && (
              <div className='h-[700px] overflow-auto'>
                <h3 className="font-semibold text-lg mb-4">All Matches</h3>
                {/*
                Example player object; replace with your actual data as needed.
              */}
 <div className="bg-mint-100 rounded-md  px-4 py-2">
