    ...
    <div className="w-full min-h-screen">
      <div className="h-screen flex justify-center p-6 items-center bg-[#EFFFF8] w-full">
        <div className="bg-[white] rounded-[30px] p-[20px] md:p-[100px] shadow-lg md:max-w-[694px] w-full">
          ...
          <div className="flex justify-between mt-[30px] w-full max-w-[494px] mx-auto">
            {[...Array(5)].map((_, i) => (
              <input
                key={i}
                maxLength={1}
          ...
          <div className="mt-[30px]">
            <button
              className="md:max-w-[494px] w-full bg-primary text-[#007745] py-3 px-4 rounded-md hover:bg-primary-dark transition duration-200  focus:outline-none focus:ring-0"
              style={{
                boxShadow:
          ...
          <div className="w-full mt-[32px] flex items-center justify-center">
            <p className="w-full flex items-center gap-[2px] font-[400] text-[14px] sm:text-[16px] justify-center">
              ...
              <Link
                className="underline text-[#769B8A] "
                to={'/create-account'}
              >
                {' '}
                Resend Code
